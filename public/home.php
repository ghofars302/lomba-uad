                    ...
                    <div class="row d-flex justify-content-center">
                      <div class="col-lg-8">
                        <div class="text-white">
                          <h2 class="mb-4 px-4 px-md-5 display-3 fw-bold ls-tight">
                            <span>SEKOLAH PARA JUARA</span>
                            <br>
                            <span class="">363</span>
                          </h2>
            ...
            <section class="mb-10 text-center">
              ...
              <div class="row gx-lg-5">
                ...
                <div class="col-lg-4 mb-6 mb-lg-0">
                  <div class="card shadow-2-strong">
                    <div class="bg-image hover-overlay ripple shadow-4-strong rounded mx-3" data-mdb-ripple-color="light" style="margin-top: -15px">
                      <img src="https://mdbcdn.b-cdn.net/img/new/standard/city/031.webp" class="img-fluid" alt="" aria-controls="#picker-editor">
                    </div>
                    <div class="card-body">
                      <h5 class="card-title">Travel to Italy</h5>
                ...
                <div class="col-lg-4 mb-6 mb-lg-0">
                  <div class="card shadow-2-strong">
                    <div class="bg-image hover-overlay ripple shadow-4-strong rounded mx-3" data-mdb-ripple-color="light" style="margin-top: -15px">
                      <img src="https://mdbcdn.b-cdn.net/img/new/standard/city/081.webp" class="img-fluid" alt="" aria-controls="#picker-editor">
                    </div>
                    <div class="card-body">
                      <h5 class="card-title">Chasing the sun</h5>
            ...
            <section class="mb-10">
              ...
              <div class="row gx-lg-5 align-items-center mb-5 flex-lg-row-reverse">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                  ...
                  <p class="text-muted">Suspendisse in volutpat massa. Nulla facilisi. Sed aliquet diam orci, nec ornare metus semper sed. Integer volutpat ornare erat sit amet rutrum.</p>
                </div>
              </div>
            </section>
          </section>
