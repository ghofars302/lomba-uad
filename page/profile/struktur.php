...
<html lang="en">
    <head>
        ...
        <title>SMA Negeri 1 Pringsewu | Struktur Organisasi</title>
        <!-- MDB icon -->
        ...
        <div id="preview" class="preview">
            ...
            <div>
                ...
                <div class="container <?php $_COOKIE['theme'] == 2 ? print ' navbar-dark bg-dark' : print 'navbar-light bg-white' ?>">
                    <div class="row pt-2">
                        <h1 class="text-center"> Struktur Organisasi SMA Negeri 1 Pringsewu </h1>
                    </div>
                    <div class="row pt-2">
                        <img src="/api/struktur-img" alt="Struktur Organisasi" class="img-fluid" draggable="false">
                    </div>
                </div>
