...
<html lang="en">
    <head>
        ...
        <title>SMA Negeri 1 Pringsewu | Visi & Misi</title>
        <!-- MDB icon -->
    ...
    <body>
        ...
        <div id="preview" class="preview">
            ...
            <div>
                ...
                <div class="container <?php $_COOKIE['theme'] == 2 ? print 'bg-dark' : print 'bg-white' ?>">
                    <div id="carouselSchoolImages" class="carousel slide carousel-fade" data-mdb-ride="carousel">
                        ...
                        <div class="carousel-inner shadow-4-strong">
                            ...
                            <div class="carousel-item active">
                                <img src="https://smansapringsewu.sch.id/wp-content/uploads/2019/07/Webp.net-resizeimage-1-768x375.png" style="background-size: contain; height: 50%" class="d-block w-100" alt="Gerbang Sekolah"/>
                                <div class="carousel-caption">
                                    <h1 style="text-shadow: 1px 2px black">VISI & MISI</h1>
                                    <h3 style="text-shadow: 1px 2px black">SMA NEGERI 1 PRINGSEWU</h3>
                                </div>
                            </div>
                        </div>
                        <!-- Inner -->
                        <figcaption><i>SMA Negeri 1 Pringsewu</i></figcaption>
                    </div>
                </div>
                <div id="content-text" class="container bg-light rounded">
                    <br/>
                    <p><strong>1. Visi</strong>
                    <br>“SMA NEGERI 1 Pringsewu Unggul akademis dan nonakademis berlandaskan agama, sosial dan budaya”</p>
                    
                    <p>Indikator :
                        <br>o Unggul dalam perolehan nilai siswa baru
                        <br>o Unggul dalam perolehan nilai ujian akhir
                        <br>o Unggul dalam memasuki PTN
                        <br>o Unggul dalam lomba-lomba intrakurikuler dan ekstrakurikuler
                        <br>o Unggul dalam kedisiplinan
                        <br>o Unggul dalam aktivitas keagamaan
                        <br>o Unggul dalam administrasi</p>
                    
                    <p><strong>2. Misi</strong></p>
                    
                    <ol>
                        <li>Melaksanakan penerimaan siswa baru melalui seleksi akademis</li>
                        <li>Melaksanakan kegiatan belajar mengajar dan bimbingan secara efektif sehingga siswa berkembang sesuai dengan potensi yang dimilikinya.</li>
                        <li>Menumbuhkan semangat keunggulan dan percaya diri kepada seluruh warga sekolah.</li>
                        <li>Mendorong dan membantu siswa untuk mengenali potensi dirinya sehingga dapat dikembangkan secara positif.</li>
                        <li>Menanamkan jiwa kreatif dan inovatif baik akademis maupun nonakademis bagi warga sekolah sehingga tidak tertinggal oleh IPTEK</li>
                        <li>Mengembangkan iptek berwawasan global (jaringan internet) baik KBM maupun administrasi.</li>
                        <li>Menumbuhkan penghayatan terhadap ajaran agama yang dianut sehingga menjadi manusia pengamal yang arif dan bijaksana</li>
                        <li>Menerapkan manejemen partisipasi dengan melibatkan seluruh warga sekolah.</li>
                        <li>Meningkatkan kedisiplinan bagi seluruh warga sekolah.</li>
                        <li>Meningkatkan kerjasama dengan unsur masyarakat, komite sekolah maupun instansi lain yang terkait.</li>
                        <li>Meningkatkan kesejahteraan guru dan karyawan.</li>
                        <li>Meningkatkan orinentasi belajar dengan digital librarary ( perpustakaan Digital )</li>
                        <li>Meningkatkan Kualitas belajar siswa berorientasi pada TI</li>
                    </ol>
                <br/>
                </div>
